...
@Component({
  selector: 'app-editassociations',
  templateUrl: './editassociations.component.html',
  styleUrls: ['./editassociations.component.css']
})
export class EditassociationsComponent implements OnInit {
  ...
  onSubmit() {
    ...
    this.apiService.updateAssociation(this.editForm.value)
