...
@Component({
  selector: 'app-getassociations',
  templateUrl: './getassociations.component.html',
  styleUrls: ['./getassociations.component.css']
})
export class GetassociationsComponent implements OnInit {
  ...
  addAssociations(): void {
    ...
    this.router.navigate(['addassociations']);
  };
  ...
  ngOnInit() {
    ...
    if (localStorage.getItem("currentUserRole") !== "Admin") {
      ...
      this.columnDefs = [
        ...
        { field: 'Type', sortable: true, filter: true, width: '150', filterParams: dateFilterParams },
        { field: 'Description', sortable: true, filter: true, width: '150', filterParams: dateFilterParams },
        { field: 'UpdatedBy', sortable: true, filter: true, width: '150', filterParams: dateFilterParams },
  ...
  rowData = [
    { Type: 'Association Type', Description: 'Association Description', CreatedDate: '2013-01-01',UpdatedBy:'Admin' }
