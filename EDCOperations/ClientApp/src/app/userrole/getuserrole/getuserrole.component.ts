...
@Component({
  selector: 'app-getuserrole',
  templateUrl: './getuserrole.component.html',
  styleUrls: ['./getuserrole.component.css']
})
export class GetuserroleComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (localStorage.getItem("currentUserRole") !== "Admin") {
      ...
      this.columnDefs = [
        ...
        { field: 'Role', sortable: true, filter: true, width: '150', filterParams: dateFilterParams },
  ...
  rowData = [
    { Role: 'Admin', CreatedDate: '2021-04-14', UpdatedBy: 'Admin' },
    { Role: 'Editor', CreatedDate: '2021-04-14', UpdatedBy: 'Admin' },
    { Role: 'Reader', CreatedDate: '2021-04-14', UpdatedBy: 'Admin' }
