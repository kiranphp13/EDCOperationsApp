...
@Component({
  selector: 'app-adduserstatus',
  templateUrl: './adduserstatus.component.html',
  styleUrls: ['./adduserstatus.component.css']
})
export class AdduserstatusComponent implements OnInit {
  ...
  onSubmit() {
    ...
    this.apiService.createUserStatus(this.addForm.value)
