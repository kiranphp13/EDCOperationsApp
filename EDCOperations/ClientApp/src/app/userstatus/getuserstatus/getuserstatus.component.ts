...
@Component({
  selector: 'app-getuserstatus',
  templateUrl: './getuserstatus.component.html',
  styleUrls: ['./getuserstatus.component.css']
})
export class GetuserstatusComponent implements OnInit {
  ...
  addUserStatus(): void {
    ...
    this.router.navigate(['adduserstatus']);
  };
  ...
  ngOnInit() {
    ...
    if (localStorage.getItem("currentUserRole") !== "Admin") {
      ...
      this.columnDefs = [
        ...
        { field: 'Status', sortable: true, filter: true, width: '150', filterParams: dateFilterParams },
  ...
  rowData = [
    { Status: 'Active', CreatedDate: '2013-01-01', UpdatedBy: 'Admin' },
    { Status: 'Inactive', CreatedDate: '2013-01-01', UpdatedBy: 'Admin' }
