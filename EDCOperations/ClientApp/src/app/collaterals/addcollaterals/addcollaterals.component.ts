...
@Component({
  selector: 'app-addcollaterals',
  templateUrl: './addcollaterals.component.html',
  styleUrls: ['./addcollaterals.component.css']
})
export class AddcollateralsComponent implements OnInit {
  ...
  onSubmit() {
    ...
    this.apiService.createCollateral(this.addForm.value)
