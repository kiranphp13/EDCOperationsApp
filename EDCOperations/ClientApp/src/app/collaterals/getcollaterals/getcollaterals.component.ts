...
@Component({
  selector: 'app-getcollaterals',
  templateUrl: './getcollaterals.component.html',
  styleUrls: ['./getcollaterals.component.css']
})
export class GetcollateralsComponent implements OnInit {
  ...
  addCollaterals(): void {
    ...
    this.router.navigate(['addcollaterals']);
  };
  ...
  rowData = [
    { Type: 'Collateral Type', Description: 'Collateral Description', CreatedDate: '2013-01-01', UpdatedBy: 'Admin' }
