...
@Component({
  selector: 'app-editcollaterals',
  templateUrl: './editcollaterals.component.html',
  styleUrls: ['./editcollaterals.component.css']
})
export class EditcollateralsComponent implements OnInit {
  ...
  onSubmit() {
    ...
    this.apiService.updateCollateral(this.editForm.value)
