...
@Component({
  ...
  templateUrl: './edcusers.component.html',
  styleUrls: ['./edcusers.component.css']
})
export class EdcusersComponent implements OnInit {
  ...
  addUser(): void {
    this.router.navigate(['administration/edc-users/add']);
  }
