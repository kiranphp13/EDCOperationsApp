...
@Component({
  selector: 'app-agencies-button-renderer',
  template: `

    <span *ngIf="loggedUserRole==='Admin'|| loggedUserRole === 'Editor'"><a class="mr-2" [routerLink]="['/administration/agencies/edit', _id]">Edit</a>&nbsp;</span>
