...
@Component({
  selector: 'app-addcontacttypes',
  templateUrl: './addcontacttypes.component.html',
  styleUrls: ['./addcontacttypes.component.css']
})
export class AddcontacttypesComponent implements OnInit {
  ...
  onSubmit() {
    ...
    this.apiService.createContactType(this.addForm.value)
