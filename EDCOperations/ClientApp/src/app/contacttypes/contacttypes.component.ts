...
@Component({
  ...
  styleUrls: ['./contacttypes.component.css']
})
export class ContacttypesComponent implements OnInit {
  ...
  addContactTypes(): void {
    
    this.router.navigate(['addcontacttypes']);
  };
  ...
  rowData = [
    { Type: 'Contact Type', Description: 'Contact Description', CreatedDate: '2013-01-01',UpdatedBy:'Admin' }
